...
echo
	...
	git clone https://github.com/Sugarcrisp-ui/alis $buildFolder/archiso/airootfs/alis
	mkdir $buildFolder/archiso/airootfs/alis-dev
	git clone https://github.com/Sugarcrisp-ui/alis-dev $buildFolder/archiso/airootfs/alis-dev
